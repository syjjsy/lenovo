...
#from lossnpcc import MonodepthLoss
...
def return_arguments():
    ...
    parser.add_argument('--model_path', help='path to the trained model',default='./model/0913.pth')

    parser.add_argument('--loadmodel', default='/media/user134/1A8C35F58C35CBCF/syj/erf/models/face323e33py_cpt.pth',
                    help='load model')                    
