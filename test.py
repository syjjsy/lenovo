...
def return_arguments():
    ...
    parser.add_argument('--data_dir',
                        ...
                        default='/media/gel/数据库1/Data/DataSet/4. 0713 单TM双目标单尺度 有重叠/train/'
                        )
    parser.add_argument('--loadmodel', default='/media/gel/数据库1/Code/pickle/models/0926_new_4_val_cpt.pth',
                    help='load model')                    
